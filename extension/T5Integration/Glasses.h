...
namespace GlassesState {
	...
	const uint16_t TRACKING_GAMEBOARDS	= 0x00000400; //10000000000
}
// clang-format on
...
private:
	...
	std::vector<uint8_t> _previous_gameboard_state;	// JSTEVENS@T5: This plain uint8_t feels kind of opaque...
